...
const AppPlayerBar: FC<IProps> = () => {
  ...
  const { currentSong, lyrics, lyricIndex, playMode } = useAppSelector(
    (state) => ({
      currentSong: state.yyplayerReducer.currentSong,
      lyrics: state.yyplayerReducer.lyrics,
      lyricIndex: state.yyplayerReducer.lyricIndex,
      playMode: state.yyplayerReducer.playMode
    }),
    appShallowEqual
  );
